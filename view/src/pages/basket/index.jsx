...
function Basket() {
    return (
        <div>
            <Header />
            <div style={{ height: "calc(100vh - 144px)"}} className='pt-5 px-6 overflow-scroll scrollbar-hide'>
                <h1 className='font-vazirmatn text-xs  text-slate-900 font-semibold mb-1'>سبد خرید شما</h1>
