...
function ProductCard({name="شلوار اسکینی old navy" , price=450000 , image , starRank="4.1" , link}) {
    return (
        ...
        <div className="flex-shrink-0 w-full flex flex-col gap-2 rounded-2xl p-2 mb-1 bg-fafafa border border-[#E6E6E6] overflow-hidden">
            <img className='w-full rounded-lg' src={ProductImageTest} alt="product image" />
            <p className='text-sm md:text-base lg:text-lg font-vazirmatn text-neutral-800 font-bold'>{name}</p>
